   ...
   <div class="container">
        <header class="p-3 mb-3 border-bottom">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <li><a href="" class="nav-link px-2 link-dark">Danh Sách Sản Phẩm</a></li>
        ...
        <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>ĐƠN VỊ</th>
                            <th>ẢNH</th>
                            <th colspan="2"><a href="\WEB16305\Assignment_PHP1\chuc_nang_sp\them_sp_form.php" class="btn btn-success">THÊM</a></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php for ($i=0; $i < count($kq); $i++) {  ?>
                            <tr>
                                ...
                                <td><?php echo $kq[$i]['so_luong'] ?></td>
                                <td><?php echo $kq[$i]['gia'] ?></td>
                                <td><?php echo $kq[$i]['don_vi'] ?></td>
                                <td><img src="<?php echo $kq[$i]['img'] ?>" style="width:100px; height:100px" alt=""></td>
                                <td><a href="\WEB16305\Assignment_PHP1\chuc_nang_sp\sua_sp.php?id=<?php echo $kq[$i]['id'] ?>" class="btn btn-primary">SỬA</a></td>
                                <td>
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">XÓA</button>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="\WEB16305\Assignment_PHP1\chuc_nang_sp\xoa_sp.php?id=<?php echo $kq[$i]['id'] ?>" class="btn btn-danger">XÓA</a>
                                        </div>
                                        </div>
                                    </div>
                                    </div>
