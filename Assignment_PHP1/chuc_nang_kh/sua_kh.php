...
<body>
    <div class="container">
        <header class="p-3 mb-3 border-bottom">
            ...
            <form class="col-8 offset-2" method="POST" action="\WEB16305\Assignment_PHP1\chuc_nang_kh\update_kh.php">
                ...
                <div class="mt-3">
                    <label>SDT</label>
                    <input class="form-control" type="number" name="sdt" value="<?php echo $data['sdt'] ?>" />
                </div>
                <div class="mt-3">
                    <label>ĐỊA_CHỈ</label>
                    <input class="form-control" type="text" name="dia_chi" value="<?php echo $data['dia_chi'] ?>"/>
                </div>
                <div class="mt-3">
                    <label>GIỚI TÍNH</label>
                    <select name="gioi_tinh" class="form-control">
                    <option <?php echo $data['gioi_tinh'] == 0 ? "selected" : "" ?> value="0">Nữ</option>
                    <option <?php echo $data['gioi_tinh'] == 1 ? "selected" : "" ?> value="1">Nam</option>
                    </select>
                </div>
                <div class="mt-3">
                    <label>EMAIL</label>
