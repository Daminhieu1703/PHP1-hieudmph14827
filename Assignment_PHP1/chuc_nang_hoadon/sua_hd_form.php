...
<body>
    <div class="container">
        <header class="p-3 mb-3 border-bottom">
            ...
            <form class="col-8 offset-2" method="POST" action="\WEB16305\Assignment_PHP1\chuc_nang_hoadon\sua_hd.php">
                <input type="hidden" name="id" value="<?php echo $id ?>">
                <div class="mt-3">
                    <label>TÊN KHÁCH HÀNG</label>
                    <input class="form-control" type="text" name="ten_kh" value="<?php echo $value['ten_kh'] ?>">
                </div>
                <div class="mt-3">
                    <label>SDT</label>
                    <input class="form-control" type="number" name="sdt" value="<?php echo $value['sdt'] ?>">
                </div>
                <div class="mt-3">
                    <label>ĐỊA_CHỈ</label>
                    <input class="form-control" type="text" name="dia_chi" value="<?php echo $value['dia_chi'] ?>">
                </div>
                <div class="mt-3">
                    <label>TỔNG TIỀN</label>
                    <input class="form-control" type="number" name="tong_tien" value="<?php echo $value['tong_tien'] ?>">
                </div><br>
                <div class="d-grid gap-2 fw-bold text-danger text-center">
                <?php if (isset($_SESSION['error3'])) {echo $_SESSION['error3']; unset($_SESSION['error3']);}?>
                    <!--
